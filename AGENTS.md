# AGENTS.md - Vigil Working Context

This file is intentionally short so Codex starts quickly and focuses on the current engineering task. The full historical context was preserved before slimming:
